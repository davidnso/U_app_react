...
export default class FilterBar extends Component {
  ...
  toggleSelected = () => {
    ...
    if (!this.state.family.isSelected) {
  ...
  render() {
    return (
      ...
      >
        <TouchableOpacity
          activeOpacity={0.5}
          style={{ width: 50, height: 60, alignContent: "center" }}
          onPress={() => {
            this.toggleSelected();
          }}
        >
          ...
          >
            <Text style={{ fontSize: 12, fontWeight: "100", color: "#A5ABA9" }}>
              Family
            </Text>
          </View>
        </TouchableOpacity>
        ...
        >
          ...
          <View
            style={{
              width: 50,
              borderRadius: 30,
              backgroundColor: !this.state.family.isSelected
                ? "#EEEEEE"
                : "#0FD3DD",
              alignItems: "center",
              marginTop: 5
