        ...
        return (
            <View style={styles.container}>
                <View style={styles.myCircleTextWrapper}>
                    <TouchableOpacity activeOpacity={.8} onPress={this.toggleMyCircleSelected}>
                    <Text style={{
                                fontFamily: 'roboto',
                                fontSize: 17,
                                fontWeight: 'bold',
                        ...
                        <View style={{
                                width: 20,
                                height: 20,
                                backgroundColor: this.state.myCircle.selected? '#FFFF': '#D3D3D3',
                                borderRadius: 5,
                                position: 'absolute',
                                right: 40,
                                bottom:4
                            ...
                            <Text style={{
                                ...
                                fontSize: 14,
                                textAlign: 'center'
                            }}>{this.state.myCircle.messagesRemaining}</Text>
                        </View>
                    </TouchableOpacity>
                </View>
                { this.state.myCircle.selected && (<Animated.View style={[styles.selectedLine, {width: this.state.myCircle.lineWidth}]}></Animated.View>)}
                <View style={styles.AcquaintanceTextWrapper}>
                    <TouchableOpacity activeOpacity={.8} onPress={this.toggleAcquaintanceSelected}> 
                        <Text style={{
                            fontFamily: 'roboto', 
                            fontSize: 17,
                            fontWeight: 'bold',
                        ...
                        <View style={{
                                width: 20,
                                height: 20,
                                backgroundColor: this.state.Acquaintances.selected? '#FFFF': '#D3D3D3',
                                borderRadius: 5,
                                position: 'absolute',
                                right: 22,
                                bottom:4
                            ...
                            <Text style={{
                                ...
                                fontSize: 14,
                                textAlign: 'center'
                            }}>{this.state.Acquaintances.messagesRemaining}</Text>
                        </View>
                    </TouchableOpacity>
                </View>
                {this.state.Acquaintances.selected && <Animated.View style={[styles.AcquaintanceSelectedLine, {width: this.state.Acquaintances.lineWidth}]}></Animated.View>}
            </View>
        )
    }
}
